document.addEventListener("DOMContentLoaded", function () {
  ...
  function toggleContentAndVisibility() {
    ...
    toggleModifyButtonContent();
  }
  function toggleModifyButtonContent() {
    modifyButton.innerText =
      modifyButton.innerText === "Modify" ? "Back" : "Modify";
  }
  ...
  function toggleVisibility(element) {
    ...
    pfButtons.style.height =
      pfButtons.style.height === "112px" ? "56px" : " 112px";
  }
